...
export default function Footer() {
  return (
    <motion.footer
      ...
      className="border-t border-espresso/10 bg-espresso text-cream"
    >
      <div className="mx-auto max-w-7xl px-6 py-16">
        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4 lg:grid-cols-5">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1">
            ...
            <p className="mt-3 max-w-xs text-sm leading-relaxed text-cream/60">
              The free POS built for Indian cafes. Turn any Android phone into a
              full point of sale.
            </p>
          </div>
        ...
        <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
          ...
          <div className="flex items-center gap-4">
            <a
              href="#"
              className="text-cream/40 transition-colors hover:text-white"
          ...
          <div className="flex items-center gap-3">
            <span className="rounded-lg border border-cream/20 px-3 py-1.5 text-xs text-cream/50">
