...
$featureDetails = [
    ...
    ['id' => 'gst', 'title' => 'GST invoicing', 'headline' => 'Every bill is CA-ready.', 'description' => 'Invoices include your GSTIN, HSN/SAC codes, and tax breakdowns per CBIC guidelines. Export to Excel for your chartered accountant at the end of each month.', 'bullets' => ['GSTIN & HSN/SAC codes on every invoice', 'Automatic CGST/SGST or IGST calculation', 'GST summary reports by period', 'Export to Excel / CSV', 'Compliant with latest CBIC guidelines']],
