...
$hero = [
    ...
    'sub' => 'Turn any phone or tablet into a full point of sale. Works offline, GST-ready, set up in minutes — no new hardware to buy.',
...
$features = [
    [
        'id' => 'billing', 'icon' => 'receipt', 'title' => 'Billing',
        'headline' => 'Take orders and print GST invoices in seconds — even when the internet drops.',
        'bullets' => [
    ...
    [
        ...
        'headline' => 'UPI, cards, cash — record every payment the way your customers already pay.',
        'bullets' => [
    ...
    [
        ...
        'headline' => 'Know when the milk runs low before the morning rush does.',
        'bullets' => [
    ...
    [
        'id' => 'reports', 'icon' => 'bar-chart', 'title' => 'Reports',
    ...
    [
        'id' => 'staff', 'icon' => 'users', 'title' => 'Staff',
    ...
    [
        'id' => 'customers', 'icon' => 'heart', 'title' => 'Customers',
    ...
    [
        'id' => 'multi-outlet', 'icon' => 'building', 'title' => 'Multi-outlet',
...
$businessTypes = [
    ['name' => 'Cafe', 'href' => '/cafe-pos', 'active' => true, 'description' => 'Counter billing, KOT, modifiers, UPI — built for the cafe workflow.'],
    ['name' => 'Coffee shop', 'href' => '/cafe-pos', 'active' => true, 'description' => 'Quick-service billing with customisable drink modifiers and loyalty.'],
    ['name' => 'Bakery', 'href' => '/cafe-pos', 'active' => true, 'description' => 'Weigh-and-bill, box combos, and expiry tracking for fresh goods.'],
    ['name' => 'Cloud kitchen', 'href' => '/cafe-pos', 'active' => true, 'description' => 'Multi-brand menus, aggregator order sync, and real-time KDS.'],
    ['name' => 'Restaurant', 'href' => '/restaurant-pos', 'active' => true, 'description' => 'Table management, KDS, split bills, and multi-floor layouts.'],
    ['name' => 'Guest house', 'href' => '/guesthouse-pos', 'active' => true, 'description' => 'Room-folio billing, check-in/out, and housekeeping queues.'],
];
